 ...
 *    thirdParty: boolean indicating whether the required file was for an node library or a file
 *    localToProject: boolean indicating whether the require was called within the boundaries of the project involved (the project the grunt task was called in)
 *  }
 *
 *  Usage:
 *
...
var lib = {
  ...
  require: function(library) {
    ...
    if(explicitSkip) {
      return console.log1("explicit skip on require", library);
    }
